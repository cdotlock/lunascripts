...
// Lexer tokenizes an LS script source string.
type Lexer struct {
	src  []rune
...
// isIdentStart returns true for runes that can start an LS identifier.
func isIdentStart(ch rune) bool {
	return unicode.IsLetter(ch) || ch == '_'
}

// isIdentContinue returns true for runes that can continue an LS identifier
